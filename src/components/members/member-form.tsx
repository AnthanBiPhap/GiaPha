...
export function MemberForm({ familyId, member, members = [], onSaved, onCancel }: Props) {
  ...
  return (
    <form onSubmit={onSubmit} className="min-h-0 flex-1 space-y-5 overflow-y-auto overscroll-contain">
      ...
      <div className="flex justify-end gap-2 border-t border-border pt-4 pb-[max(0.5rem,env(safe-area-inset-bottom))]">
